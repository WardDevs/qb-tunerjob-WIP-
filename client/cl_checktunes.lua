...
--========================================================= CheckTunes
RegisterNetEvent('qb-tunerjob:client:checkVehicleModsWorkStation', function() 
...
--[[ 			QBCore.Functions.Progressbar("repair-clean", "Plugging in OBD2 Scanner...", 5000, false, true, {
				...
				disableCombat = true,
						...
						TriggerEvent("qb-tunerjob:client:workStationMainMenuExtra")
					TriggerEvent("qb-tunerjob:client:workStationMainMenuExtra")
            ...
            QBCore.Functions.Progressbar('"repair-clean', 'Plugging in OBD2 Scanner...', 5000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
                disableMovement = true,
...
function checkVehicleModsWorkStation()
	...
	TriggerEvent('qb-tunerjob:client:workStationOptions')
